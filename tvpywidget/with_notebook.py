...
try:
	...
	print("Unable to import jupyterlab")
	pass
else:
    ...
    if (jupyterlab.__version__ >= '0.35.0') and (jupyterlab.__version__ < '1.0.0'):
        ...
        try:
            ...
            print("PermissionError: Unable to install /vpython_data directory and files for VPython on JupyterLab")
            pass

print("jupyter dir", jd, os.listdir(jd))
print("nbextensions dir", nbdir, os.listdir(nbdir))
print("nblib dir", nblib, os.listdir(nblib))
print("notebook version is", notebook.__version__)

if ('nbextensions' in os.listdir(jd)) and (notebook.__version__ <= '6.5.5'):
    print("check packages in nbextensions")
...
if transfer and (notebook.__version__ <= '6.5.5'):
    print("transfer new nbextensions")
...
# wtf...
if ('nbextensions' in os.listdir(jd)) and (notebook.__version__ <= '6.5.5'):
    print("start injecting js bundles")
...
def start_server():
    print("starting tornado http server on port", __SOCKET_PORT)
...
t.start()
print("started thread for tornado server")
