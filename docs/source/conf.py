...
# -*- coding: utf-8 -*-
#
# tvpywidget documentation build configuration file
#
...
project = 'tvpywidget'
copyright = '2024, Vasya Zhirnov'
author = 'Vasya Zhirnov'
...
_version_py = os.path.join(repo, 'tvpywidget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'tvpywidgetdoc'
...
latex_documents = [
    (master_doc, 'tvpywidget.tex', 'tvpywidget Documentation',
     'Vasya Zhirnov', 'manual'),
]
